...
log_reg_accuracy_train = accuracy_score(y_train, log_reg_model.predict(x_train))
...
decision_tree_accuracy_train = accuracy_score(y_train, dec_tree_model.predict(x_train))
print("DecisionTreeClassifier train accuracy: " + str(decision_tree_accuracy_train))
decision_tree_accuracy_test = accuracy_score(y_test, dec_tree_model.predict(x_test))
print("DecisionTreeClassifier test accuracy: " + str(decision_tree_accuracy_test))
